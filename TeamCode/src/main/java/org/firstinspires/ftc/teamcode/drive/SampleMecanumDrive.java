...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(8, 0, 1); //kP = 8  kD = 1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(2, 0, 0.5); //kP = 2, kD = 0.5
